    ...
    <>
      ...
      <div className="flex h-screen -mt-20 w-full h-full">
        <div className="m-auto w-full lg:w-2/5 p-auto">
          ...
          <div className="mb-7">
            <label className="block text-lg font-light mb-2" for="password">
              Password
            </label>
            <div className="flex w-full bg-drabya-gray items-center border-gray-500 appearance-none border p-4 font-light leading-tight rounded bg-white">
          ...
          <div class="flex items-center justify-between mb-6">
            ...
            <button
              class=" bg-indigo-600 hover:bg-blue-700 text-white font-light py-3 px-20 rounded focus:outline-none focus:shadow-outline"
              type="button"
            >
              LOGIN
            </button>
